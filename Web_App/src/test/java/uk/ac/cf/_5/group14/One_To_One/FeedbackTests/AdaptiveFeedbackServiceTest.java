...
import uk.ac.cf._5.group14.One_To_One.FeedbackData.AdaptiveFeedbackAiService;
...
import uk.ac.cf._5.group14.One_To_One.FeedbackData.AdaptiveFeedbackTone;
...
class AdaptiveFeedbackServiceTest {
    ...
    void shouldRejectNonSupportiveFeedbackAndTryAgain() {
        ...
        when(aiService.suggestFeedback(eq(today), any(), anyString(), anyList()))
                .thenReturn("You are lazy.", "Youâ€™ve got this â€” keep going.");
