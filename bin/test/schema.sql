...
-- Added for notes and gamification
...
(
    ...
    constraint fk_note_folders_user_test
...
(
    ...
    created_at timestamp    not null default current_timestamp,
    updated_at timestamp    not null default current_timestamp,
    constraint fk_notes_user_test foreign key (user_id) references users (id) on delete cascade,
    constraint fk_notes_folder_test foreign key (folder_id) references note_folders (id) on delete cascade
) engine = InnoDB;
...
(
    ...
    constraint fk_user_points_user_test foreign key (user_id) references users (id) on delete cascade
) engine = InnoDB;
