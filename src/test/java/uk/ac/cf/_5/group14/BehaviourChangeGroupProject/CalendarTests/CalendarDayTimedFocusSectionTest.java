...
@ActiveProfiles("test")
class CalendarDayTimedFocusSectionTest {
    ...
    void dayViewRendersTimedFocusSection() throws Exception {
        ...
        mvc.perform(get("/calendar/day/2026-01-15").sessionAttr("user", sessionUser))
                ...
                .andExpect(content().string(org.hamcrest.Matchers.containsString("Timed Focus")))
                .andExpect(content().string(org.hamcrest.Matchers.containsString("data-testid=\"timed-focus\"")))
                .andExpect(content().string(org.hamcrest.Matchers.containsString("Automatic")));
    }
