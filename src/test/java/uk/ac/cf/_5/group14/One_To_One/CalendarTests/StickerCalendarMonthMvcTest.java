...
import uk.ac.cf._5.group14.One_To_One.UserSettings.StickerPackPreference;
...
class StickerCalendarMonthMvcTest {
    ...
    void monthViewHtmlContainsModeToggle() throws Exception {
        ...
        // with pack and target info â€” toggle buttons are in the outer page, not the fragment
        mvc.perform(get("/calendar/month-fragment")
                        .param("month", "3")
                        .param("year", "2026")
                        .sessionAttr("user", user))
