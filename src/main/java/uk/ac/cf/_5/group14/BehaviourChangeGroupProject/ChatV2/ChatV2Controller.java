...
import uk.ac.cf._5.group14.BehaviourChangeGroupProject.Chat.ChatContext;
import uk.ac.cf._5.group14.BehaviourChangeGroupProject.Chat.ChatContextService;
import uk.ac.cf._5.group14.BehaviourChangeGroupProject.Chat.ChatPromptBuilder;
    ...
    private ChatV2Response handleCommand(User user, ChatV2CommandParser.ParsedCommand parsed) {
        ...
        switch (parsed.type()) {
            ...
            case "SCHEDULE_LIST" -> {
                ...
                occs.forEach(o -> {
                    if (o instanceof uk.ac.cf._5.group14.BehaviourChangeGroupProject.ScheduleData.ScheduleOccurrence occ) {
