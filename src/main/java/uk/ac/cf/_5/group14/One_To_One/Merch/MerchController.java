...
public class MerchController {
    ...
    private List<MerchProduct> buildDemoProducts() {
        return List.of(
            ...
            demo(4L, "Elite Gym Gloves", "Full palm padding with wrist wrap support. Breathable mesh back and non-slip silicone grip pattern â€” built for heavy lifts.", new BigDecimal("24.99"), "Accessories", "https://images.unsplash.com/photo-1517836357463-d25dfeac3438?w=600&q=80", 75, true),
            ...
            demo(8L, "Protein Shaker Bottle â€“ 1 L", "Extra-large BPA-free shaker with a pill compartment, powder funnel, and a secure twist lock lid. Dishwasher safe.", new BigDecimal("14.99"), "Accessories", "https://images.unsplash.com/photo-1546069901-ba9599a7e63c?w=600&q=80", 0, true)
        );
    }
