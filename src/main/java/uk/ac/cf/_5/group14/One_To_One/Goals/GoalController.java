...
public class GoalController {
    ...
    public String detail(@PathVariable Long id, Model model) {
        ...
        List<uk.ac.cf._5.group14.One_To_One.CalendarData.CalendarTask> linkableTasks =
            calendarTaskRepository.findByUserAndDateBetween(goal.getOwnerUser(), rangeStart, rangeEnd);
        List<uk.ac.cf._5.group14.One_To_One.ScheduleData.ScheduleOccurrence> linkableOccurrences =
